    ...
    >
      ...
      <AnimatePresence>
        {toast && (
          ...
          >
            <div className={`flex items-center gap-3 rounded-lg px-5 py-3.5 text-sm font-medium shadow-2xl ring-1 ${toast.type === 'error' ? 'bg-white text-red-600 ring-red-200' : 'bg-gray-950 text-white ring-gray-800'
              }`}
